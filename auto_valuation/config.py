...
LEARNING_CONFIG: dict[str, Any] = {
    ...
    "background_runner_loop_seconds": 300,
    "background_runner_bootstrap_interval_hours": 1,
    "background_runner_bootstrap_max_tickers": 500,
    ...
    "background_runner_exchange_refresh_batch": 5,
