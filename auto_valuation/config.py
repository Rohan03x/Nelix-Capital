...
LEARNING_CONFIG: dict[str, Any] = {
    ...
    "symbol_universe_priority_limit": 72,
    ...
    "background_runner_bootstrap_max_tickers": 10,
    "background_runner_maintenance_max_tickers": 6,
    ...
    "bootstrap_default_max_tickers_per_run": 18,
    "bootstrap_cached_ticker_limit": 48,
